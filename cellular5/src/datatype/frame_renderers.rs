        ...
        match self {
            ...
            FrameRenderers::FadeAndChild {
                ...
                if args.lerp_i == 0 {
                    ...
                    let gg_color = GgColor::new(modified_color.r.into_inner(), modified_color.g.into_inner(), modified_color.b.into_inner(), modified_color.a.into_inner());

                    ggez::graphics::draw(
                        args.ctx,
                        args.blank_texture,
                        DrawParam::new().color(gg_color).scale([
